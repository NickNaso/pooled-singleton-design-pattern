...
module.exports.createClient = function createClient(resourceName, options = {}) {
  if (!resourceName || resourceName.length === 0) {
    throw new PooledResourceError("Missing or invalid parameter resourceName.");
  }
  if(resourceHandlerInstances.length !== 0 && checkInstance(resourceName, resourceHandlerInstances)) {
...
module.exports.getInstance = function getInstance(resourceName) {
  if (!resourceName || resourceName.lenght === 0 || (!checkInstance(resourceName, resourceHandlerInstances))) {
